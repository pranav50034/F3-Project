...
searchProducts.addEventListener("keyup", () => {
   ...
   for (let i = 0; i < temp.length; i++) {
      if (temp[i].innerHTML === "All") catData.push("All");
      if (temp[i].innerHTML === "Mens") catData.push("men's clothing");
      if (temp[i].innerHTML === "Womens") catData.push("women's clothing");
      if (temp[i].innerHTML === "Jewellery") catData.push("jewelery");
      if (temp[i].innerHTML === "Electronics") catData.push("electronics");
   }
